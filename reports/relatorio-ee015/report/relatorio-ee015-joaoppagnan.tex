...
\begin{subequations}
\begin{equation}
\frac{dx}{dt} = -\sigma \cdot (x(t) - y(t))
\end{equation}
\begin{equation}
\frac{dy}{dt} = x(t) \cdot (\rho - z(t)) - y(t)
\end{equation}
\begin{equation}
\frac{dz}{dt} = x(t) \cdot y(t) - \beta \cdot z(t)
\end{equation}
\end{subequations}
\begin{figure}[!ht]
\centering
...
Por causa disso, o estudo se direcionará à aplicabilidade das redes neurais à predição, ou seja, utilizando ferramentas que também são não-lineares, assim como os sistemas em estudo.
