...
\begin{tabular}{c c c c c}
 ...
 \hline
 \addlinespace
 $\bm{1}$ & $(1.758 \pm 0.130) \times 10^{-1}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{2}$ & $(5.190 \pm 1.620) \times 10^{-3}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{3}$ & $(2.346 \pm 3.765) \times 10^{-3}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{4}$ & $(6.415 \pm 4.726) \times 10^{-4}$\\
   \addlinespace
 \hline
 \addlinespace
 $\bm{5}$ & $(1.892 \pm 0.214) \times 10^{-3}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{6}$ & $(1.739 \pm 1.251) \times 10^{-3}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{7}$ & $(3.239 \pm 1.034) \times 10^{-3}$\\
 \addlinespace
 \hline
 \addlinespace
 $\bm{8}$ & $(9.436 \pm 2.631) \times 10^{-4}$\\ 
 \addlinespace
 \hline
 \addlinespace
 $\bm{9}$ & $(1.514 \pm 0.805) \times 10^{-3}$ 
\end{tabular}}
\caption{Mapa de Hénon}
\label{tab:henon-eqm}
\end{center}
