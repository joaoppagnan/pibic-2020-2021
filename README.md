...
Para simplificar a sintaxe, é recomendado instalar o pacote feito por mim para realizar essa pesquisa. É possível fazer isso rodando o seguinte comando na pasta raiz desse projeto:
```
