...
print("1: MLP, 2: LSTM, 3: GRU, 4: ESN")
model = input()
...
if (int(model) == 1):
    ...
    fig, ax = plt.subplots()
    ax.plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    ...
    axs[0].plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    ...
    sns.despine()
    axs[0].legend()    
    axs[1].plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    ...
    fig, ax = plt.subplots()
    ax.plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    ...
    sns.despine()
    axs[0].legend()    
    axs[1].plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    ...
    fig, ax = plt.subplots()
    ax.plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    ...
    sns.despine()
    axs[0].legend()    
    axs[1].plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    ...
    fig, ax = plt.subplots()
    ax.plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
    ...
    sns.despine()
    axs[0].legend()    
    axs[1].plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
...
# --------------- ESN --------------- #
    ...
    fig, ax = plt.subplots()
    ax.plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    ax.plot(n_henon, y_henon_pred, color='tab:green', label='ESN')
    #ax.set_title("Comparação da predição da MLP com o valor real do mapa de Hénon\n utilizando as melhores configurações no conjunto de teste")
    ax.set_ylabel('$x[n]$')
    ax.set_xlabel('$n$')
    ax.set_xlim(4900, n_henon[-1])
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    axs[0].plot(n_henon, y_henon_pred, color='tab:green', label='ESN')
    #axs[0].set_title("Comparação da predição da MLP com o valor real do mapa de Hénon\n utilizando as melhores configurações no conjunto de teste")
    axs[0].set_ylabel('$x[n]$')
    axs[0].set_xlabel('$n$')
    axs[0].set_xlim(4900, n_henon[-1])
    ...
    axs[0].legend()    
    axs[1].plot(n_henon, y_henon_teste, color='DarkGreen', label='Valor real')
    axs[1].plot(n_henon, y_henon_pred, color='tab:green', label='ESN')
    axs[1].set_ylabel('$x[n]$')
    axs[1].set_xlabel('$n$')
    axs[1].set_xlim(4980, n_henon[-1])
    axs[1].grid(True)
    ...
    fig, ax = plt.subplots()
    ax.plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    ax.plot(n_logistic, y_logistic_pred, color='tab:green', label='ESN')
    #ax.set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    ax.set_ylabel('$x[n]$')
    ax.set_xlabel('$n$')
    ax.set_xlim(4900, n_logistic[-1])
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    axs[0].plot(n_logistic, y_logistic_pred, color='tab:green', label='ESN')
    #axs[0].set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    axs[0].set_ylabel('$x[n]$')
    axs[0].set_xlabel('$n$')
    axs[0].set_xlim(4900, n_logistic[-1])
    ...
    axs[0].legend()    
    axs[1].plot(n_logistic, y_logistic_teste, color='Crimson', label='Valor real')
    axs[1].plot(n_logistic, y_logistic_pred, color='tab:green', label='ESN')
    axs[1].set_ylabel('$x[n]$')
    axs[1].set_xlabel('$n$')
    axs[1].set_xlim(4980, n_logistic[-1])
    axs[1].grid(True)
    ...
    fig, ax = plt.subplots()
    ax.plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    ax.plot(t_lorenz, y_lorenz_pred, color='tab:green', label='ESN')
    #ax.set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    ax.set_ylabel('$x[n]$')
    ax.set_xlabel('$n$')
    ax.set_xlim(t_lorenz[0], t_lorenz[-1])
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    axs[0].plot(t_lorenz, y_lorenz_pred, color='tab:green', label='ESN')
    #axs[0].set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    axs[0].set_ylabel('$x[n]$')
    axs[0].set_xlabel('$n$')
    axs[0].set_xlim(t_lorenz[0], t_lorenz[-1])
    ...
    axs[0].legend()    
    axs[1].plot(t_lorenz, y_lorenz_teste, color='DarkBlue', label='Valor real')
    axs[1].plot(t_lorenz, y_lorenz_pred, color='tab:green', label='ESN')
    axs[1].set_ylabel('$x[n]$')
    axs[1].set_xlabel('$n$')
    axs[1].set_xlim(47, t_lorenz[-1])
    axs[1].grid(True)
    ...
    fig, ax = plt.subplots()
    ax.plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
    ax.plot(t_mackeyglass, y_mackeyglass_pred, color='tab:green', label='ESN')
    #ax.set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    ax.set_ylabel('$x[n]$')
    ax.set_xlabel('$n$')
    ax.set_xlim(t_mackeyglass[0], t_mackeyglass[-1])
    ...
    fig, axs = plt.subplots(nrows=1, ncols=2, figsize=(10, 4))
    axs[0].plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
    axs[0].plot(t_mackeyglass, y_mackeyglass_pred, color='tab:green', label='ESN')
    #axs[0].set_title("Comparação da predição da MLP com o valor real do mapa logístico\n utilizando as melhores configurações no conjunto de teste")
    axs[0].set_ylabel('$x[n]$')
    axs[0].set_xlabel('$n$')
    axs[0].set_xlim(t_mackeyglass[0], t_mackeyglass[-1])
    ...
    axs[0].legend()    
    axs[1].plot(t_mackeyglass, y_mackeyglass_teste, color='DarkOrange', label='Valor real')
    axs[1].plot(t_mackeyglass, y_mackeyglass_pred, color='tab:green', label='ESN')
    axs[1].set_ylabel('$x[n]$')
    axs[1].set_xlabel('$n$')
    axs[1].set_xlim(4700, t_mackeyglass[-1])
    axs[1].grid(True)
