...
ax.text(esn_model[0]-0.83, MSE_esn[0], r"($3.232\pm0.549$)$\times 10^{-9}$", fontsize='medium')
...
ax.text(esn_model[0]-0.83, MSE_esn[0], r"($1.546\pm 1.651$)$\times 10^{-8}$", fontsize='medium')
...
ax.text(esn_model[0]-0.83, MSE_esn[0], r"($1.523\pm 1.240$)$\times 10^{-6}$", fontsize='medium')
...
ax.text(esn_model[0]-0.83, MSE_esn[0], r"($4.380\pm 0.644$)$\times 10^{-7}$", fontsize='medium')
