...
ax.text(mlp_model[0]+0.075, MSE_mlp[0], r"($8.474\pm 6.635$)$\times 10^{-4}$", fontsize='large')
ax.text(lstm_model[0]+0.075, MSE_lstm[0], r"($1.491\pm 0.752$)$\times 10^{-4}$", fontsize='large')
ax.text(gru_model[0]+0.075, MSE_gru[0], r"($3.455\pm 1.014$)$\times 10^{-4}$", fontsize='large')
ax.text(esn_model[0]-0.9, MSE_esn[0], r"($3.232\pm0.549$)$\times 10^{-9}$", fontsize='large')
...
fig.savefig("reports/relatorio-final/figures/comparacao-k-henon.pdf")
...
ax.text(mlp_model[0]+0.075, MSE_mlp[0], r"($3.572\pm 0.399$)$\times 10^{-4}$", fontsize='large')
ax.text(lstm_model[0]+0.075, MSE_lstm[0], r"($7.268\pm 4.679$)$\times 10^{-5}$", fontsize='large')
ax.text(gru_model[0]+0.075, MSE_gru[0], r"($9.782\pm 5.248$)$\times 10^{-5}$", fontsize='large')
ax.text(esn_model[0]-0.9, MSE_esn[0], r"($1.546\pm 1.651$)$\times 10^{-8}$", fontsize='large')
...
fig.savefig("reports/relatorio-final/figures/comparacao-k-logistic.pdf")
...
ax.text(mlp_model[0]+0.075, MSE_mlp[0], r"($8.038\pm 2.934$)$\times 10^{-4}$", fontsize='large')
ax.text(lstm_model[0]+0.075, MSE_lstm[0], r"($1.241\pm 0.234$)$\times 10^{-3}$", fontsize='large')
ax.text(gru_model[0]+0.075, MSE_gru[0], r"($2.632\pm 1.821$)$\times 10^{-4}$", fontsize='large')
ax.text(esn_model[0]-0.9, MSE_esn[0], r"($1.523\pm 1.240$)$\times 10^{-6}$", fontsize='large')
...
fig.savefig("reports/relatorio-final/figures/comparacao-k-lorenz.pdf")
...
ax.text(mlp_model[0]+0.075, MSE_mlp[0], r"($3.023\pm 0.470$)$\times 10^{-4}$", fontsize='large')
ax.text(lstm_model[0]+0.075, MSE_lstm[0], r"($4.180\pm 0.972$)$\times 10^{-5}$", fontsize='large')
ax.text(gru_model[0]+0.075, MSE_gru[0], r"($4.843\pm 0.997$)$\times 10^{-5}$", fontsize='large')
ax.text(esn_model[0]-0.9, MSE_esn[0], r"($4.380\pm 0.644$)$\times 10^{-7}$", fontsize='large')
...
fig.savefig("reports/relatorio-final/figures/comparacao-k-mackeyglass.pdf")
print("Gráficos gerados!")
print("")